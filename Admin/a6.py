...
MENU = "a) Login	b) Create an account	c) View accounts	q) Quit"
done = False
accounts = {}
FILE = "accounts.txt"
...
def read_file():
    ...
    for line in file_in:
        ...
        # use .rstrip() to clean up spaces or new lines after each value.
        value.rstrip()
...
while not done:
    ...
    print("\n", MENU)
    # Get the user choice
    user_choice = input("Choose [a/b/c/q]: ").lower()
    if user_choice == "a":
        login()
    elif user_choice == "b":
        create_account()
